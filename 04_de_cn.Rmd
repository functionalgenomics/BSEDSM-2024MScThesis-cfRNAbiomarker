...
```{r maplottraining, echo=FALSE, fig.height=5, fig.width=10, dpi=100, fig.cap="MA-plot training data from Roskams et al. (2022)."}
par(mfrow=c(1, 2))
...
```{r decomparison, echo=FALSE, warning=FALSE, fig.height=6, fig.width=10, dpi=100, fig.cap="Comparison DE analyis across datasets."}
...
mtext("MRoskams et al. (2022) training", side=1, line=2.2, cex=1.3)
