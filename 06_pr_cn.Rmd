...
xgboostGrid <- expand.grid(max_depth = c(3, 4, 5, 6, 7), nrounds = (1:10)*50,eta = c(0.03,0.4,0.5),gamma = c(0.5),subsample = c(1),min_child_weight = c(1),colsample_bytree = c(0.7))
