...
#dgeR.int.training <- dgeR.filt.training$counts[intersection.genes,]
#mask <- rownames()
#seR.int.training <- seR.filt.training[intersection.genes,]

#dgeB.int.training <- dgeB.filt.training$counts[intersection.genes,]
#dgeB.int.testing$counts <- dgeB.filt.testing$counts[intersection.genes,]
#seB.int.training <- seB.filt.training[instersection.genes,]
```
...
cv.pred.RandomForest <- kfoldCV.randomforest.logistic(y=tumor.training,
                                x=standardized.training, K=10,seed=1)
