...
```{r maplottraining, echo=FALSE, message=FALSE, fig.height=5, fig.width=10, dpi=100, fig.cap="MA-plot training data from Moufarrej et al. (2022)."}
par(mfrow=c(1, 2))
...
par(mfrow=c(1, 3), mar=c(4, 5, 2, 1)+ 0.1, oma=c(2, 2, 2, 2))
