...
```{r, echo = FALSE}
## Visualize for each sample its expression in MSY vs XIE
## M for "male", F for "female" and O for "missing"
rng <- range(c(msyexp, xieexp))
plot(msyexp, xieexp, pch="", xlim=rng, ylim=rng, las=1,
     xlab="Average MSY expression",
     ylab="Average XIE expression")
